...
var arr = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis repudiandae rem distinctio laudantium aperiam consequatur quia qui animi eos dolor quisquam mollitia dolore reiciendis voluptatibus officia adipisci, velit tenetur quasi?"
...
function removeBox()
{
    ...
    bodyMain.addEventListener('keypress', (event)=>{
        ...
        if (typedString.length === array.length)
        {
            ...
            es = date.getSeconds()
            var time = ((endTime - startTime)*60 + Math.abs(ss - es))/60
